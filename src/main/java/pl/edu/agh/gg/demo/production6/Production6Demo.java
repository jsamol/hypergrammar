package pl.edu.agh.gg.demo.production6;
...
public class Production6Demo {

    public static void main(String[] args) throws IOException {
        Production6Demo app = new Production6Demo();
        app.run();
    }
...
//        BufferedImage image = BitmapUtils.loadBitmapFromResource("production6/bitmap.bmp");
