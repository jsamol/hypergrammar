...
public class Demo18 {
    ...
    private void createGraphWithout2VerticesInteriorEdges(HyperGraph graph) {
        ...
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v000100, v100100));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v100100, v200100));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v200100, v300100));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v300100, v400100));

        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v000200, v200200));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v200200, v300200));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v300200, v400200));

        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v300300, v400300));
        ...
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v100000, v100100));

        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v200000, v200100));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v200100, v200200));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v200200, v200400));

        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v300000, v300100));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v300100, v300200));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v300200, v300300));
        addHyperEdge(graph, HyperEdgeType.BOUNDARY, Arrays.asList(v300300, v300400));
